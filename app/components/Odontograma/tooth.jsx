  ...
  return (
    <>
      {top ? (
        ...
        className={topClicked ? "top tooth" : "top tooth hover:bg-unselected"}
          onClick={() => {
            if (!topClicked) {
              setTopClicked(true);
              props.vestibularC();
        ...
        <div
          className={leftClicked ? "left tooth" : "left tooth hover:bg-unselected"}
          style={{
            width: "20px",
            height: "20px",
            outline: "2px solid #000",
        ...
        <div
          className={bottomClicked ? "bottom tooth" : "bottom tooth hover:bg-unselected"}
          style={{
            width: "20px",
            height: "20px",
            outline: "2px solid #000",
        ...
        <div
          className={rightClicked ? "right tooth" : "right tooth hover:bg-unselected"}
          style={{
            width: "20px",
            height: "20px",
            outline: "2px solid #000",
        ...
        <div
          className={centerClicked ? "center tooth" : "center tooth hover:bg-unselected"}
          style={{
            width: "20px",
            height: "20px",
            outline: "2px solid #000",
